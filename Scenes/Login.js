  ...
  render() {
    ...
    <View style={{ flex: 1, marginTop: 5}}>
                ...
                <View style={styles.containerInputs}>
                    ...
                    <View style={styles.inputs}><TextInput secureTextEntry={true} value={contrasena} name="userInput" onChangeText={(text) => this.setState({ contrasena: text })} /></View>
                </View>
                <View style={styles.containerBtn}>
                    <TouchableOpacity 
                            onPress={goToScene1} 
                            style={styles.btnIngresar}>
                        <View><Text style={{ fontSize: 20}}>Ingresar</Text></View>
                    </TouchableOpacity>
